...
export const RPC_ACCESS_POLICY = {
  ...
  [WS_METHODS.pullRequestsListInbox]: "operator",
  [WS_METHODS.pullRequestsSubscribeInbox]: "operator",
  [WS_METHODS.pullRequestsGetDetail]: "operator",
  [WS_METHODS.pullRequestsRefresh]: "operator",
  [WS_METHODS.pullRequestsMarkViewed]: "operator",
  [WS_METHODS.pullRequestsMarkUnread]: "operator",
  [WS_METHODS.pullRequestsAttachRelationship]: "operator",
  [WS_METHODS.pullRequestsRemoveExplicitRelationship]: "operator",
  [WS_METHODS.pullRequestsListAi]: "owner",
  [WS_METHODS.pullRequestsSubscribeAi]: "owner",
  [WS_METHODS.pullRequestsAnalyze]: "owner",
  [WS_METHODS.pullRequestsCancelAiRun]: "owner",
