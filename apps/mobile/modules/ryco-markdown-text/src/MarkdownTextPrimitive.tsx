...
import RycoMarkdownTextRunNativeComponent from "./RycoMarkdownTextRunNativeComponent";
import RycoMarkdownTextNativeComponent from "./RycoMarkdownTextNativeComponent";
...
function MarkdownTextPrimitiveChild({ style, children, ...rest }: MarkdownTextPrimitiveProps) {
  ...
  const nativeChildren = React.Children.toArray(children).map((child) => {
    ...
    return (
      ...
      <RycoMarkdownTextRunNativeComponent
  ...
  if (!isAncestor) {
    return (
      <TextAncestorContext.Provider value={contextValue}>
        <RycoMarkdownTextNativeComponent
          {...textDefaults}
          {...rest}
