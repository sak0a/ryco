...
const customSprite = webIconSource.match(/const RYCO_FILE_ICON_SPRITE = `([\s\S]*?)`;/)?.[1];

if (!customSprite) {
  throw new Error("Could not read the Pierre icon sprite from apps/web/src/pierre-icons.ts");
}
