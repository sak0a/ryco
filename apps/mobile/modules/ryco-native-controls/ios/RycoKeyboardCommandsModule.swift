...
public final class RycoKeyboardCommandsModule: Module {
  public func definition() -> ModuleDefinition {
    Name("RycoKeyboardCommands")

    View(RycoKeyboardCommandsView.self) {
      Prop("enabledCommands") { (view: RycoKeyboardCommandsView, commands: [String]) in
...
public final class RycoKeyboardCommandsView: ExpoView {
