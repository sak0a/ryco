...
import type { OrchestrationCheckpointSummary } from "@ryco/contracts";
...
// The flattened review list item model is inspired by the @pierre/diffs package's
// (MIT) iterator-first virtualization architecture, adapted here for React Native
// virtualization. Reference files in that package:
