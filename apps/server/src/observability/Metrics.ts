...
export const rpcRequestsTotal = Metric.counter("ryco_rpc_requests_total", {
  description: "Total RPC requests handled by the websocket RPC server.",
});

export const rpcRequestDuration = Metric.timer("ryco_rpc_request_duration", {
  description: "RPC request handling duration.",
});

export const orchestrationCommandsTotal = Metric.counter("ryco_orchestration_commands_total", {
  description: "Total orchestration commands dispatched.",
});

export const orchestrationCommandDuration = Metric.timer("ryco_orchestration_command_duration", {
...
export const orchestrationEventsProcessedTotal = Metric.counter(
  "ryco_orchestration_events_processed_total",
  {
    description: "Total orchestration intent events processed by runtime reactors.",
  },
);

export const providerSessionsTotal = Metric.counter("ryco_provider_sessions_total", {
  description: "Total provider session lifecycle operations.",
});

export const providerTurnsTotal = Metric.counter("ryco_provider_turns_total", {
  description: "Total provider turn lifecycle operations.",
});

export const providerTurnDuration = Metric.timer("ryco_provider_turn_duration", {
  description: "Provider turn request duration.",
});

export const providerRuntimeEventsTotal = Metric.counter("ryco_provider_runtime_events_total", {
  description: "Total canonical provider runtime events processed.",
});

export const providerEventLogRecordsDroppedTotal = Metric.counter(
  "ryco_provider_event_log_records_dropped_total",
  {
...
export const startupCommandGateEnqueuesTotal = Metric.counter(
  "ryco_startup_command_gate_enqueues_total",
  {
    description: "Total startup command gate enqueue attempts by outcome.",
  },
);

export const startupCommandGateQueueDepth = Metric.gauge("ryco_startup_command_gate_queue_depth", {
...
export const startupCommandGateQueueHighWater = Metric.gauge(
  "ryco_startup_command_gate_queue_high_water",
  {
...
export const startupCommandGateQueueWaitDuration = Metric.timer(
  "ryco_startup_command_gate_queue_wait_duration",
  {
...
export const providerStartupAdmissionTotal = Metric.counter(
  "ryco_provider_startup_admission_total",
  {
    description: "Total provider startup admission attempts by outcome.",
  },
);

export const providerStartupQueueDepth = Metric.gauge("ryco_provider_startup_queue_depth", {
...
export const providerStartupQueueHighWater = Metric.gauge(
  "ryco_provider_startup_queue_high_water",
  {
...
export const providerStartupQueueWaitDuration = Metric.timer(
  "ryco_provider_startup_queue_wait_duration",
  {
    description: "Time provider session starts spent waiting for startup admission.",
  },
);

export const gitCommandsTotal = Metric.counter("ryco_git_commands_total", {
  description: "Total git commands executed by the server runtime.",
});

export const gitCommandDuration = Metric.timer("ryco_git_command_duration", {
  description: "Git command execution duration.",
});

export const terminalSessionsTotal = Metric.counter("ryco_terminal_sessions_total", {
  description: "Total terminal sessions started.",
});

export const terminalRestartsTotal = Metric.counter("ryco_terminal_restarts_total", {
