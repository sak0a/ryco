    ...
    execute: () =>
      sql`
        SELECT
          ...
          parent_subagent_id AS "parentSubagentId",
          ...
          ([
            ...
            Effect.gen(function* () {
              ...
              const threads: ReadonlyArray<OrchestrationThread> = threadRows.map((row) => ({
                ...
                parentSubagentId: row.parentSubagentId,
  ...
  const getThreadShellById: ProjectionSnapshotQueryShape["getThreadShellById"] = (threadId) =>
    Effect.gen(function* () {
      ...
      return Option.some({
        ...
        visibility: threadRow.value.visibility,
        parentThreadId: threadRow.value.parentThreadId,
        parentSubagentId: threadRow.value.parentSubagentId,
