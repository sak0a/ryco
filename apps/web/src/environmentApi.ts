...
export function createEnvironmentApi(rpcClient: WsRpcClient): EnvironmentApi {
  return {
    ...
    browser: {
      getStatus: rpcClient.browser.getStatus,
      listProfiles: rpcClient.browser.listProfiles,
      openSession: rpcClient.browser.openSession,
      closeSession: rpcClient.browser.closeSession,
      getSnapshot: rpcClient.browser.getSnapshot,
      navigate: rpcClient.browser.navigate,
      back: rpcClient.browser.back,
      forward: rpcClient.browser.forward,
      reload: rpcClient.browser.reload,
      stop: rpcClient.browser.stop,
      input: rpcClient.browser.input,
      inspectStorage: rpcClient.browser.inspectStorage,
      clearStorage: rpcClient.browser.clearStorage,
      deleteCookie: rpcClient.browser.deleteCookie,
      onEvent: (callback) => rpcClient.browser.onEvent(callback),
    },
    projects: {
