...
export function SidebarProviderUpdatePill() {
  ...
  return (
    <div
      className={`group/provider-update relative flex h-7 w-full items-center overflow-hidden rounded-lg text-xs font-medium transition-[opacity,transform] duration-180 ease-[cubic-bezier(0.22,1,0.36,1)] ${
