...
const SVG =
  "ryco-proc overflow-visible [&_*]:[vector-effect:non-scaling-stroke]";
...
export function InstallIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 100 100" className={`${SVG} ryco-install ${className ?? ""}`} {...base} aria-hidden>
...
export function LaunchIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 100 100" className={`${SVG} ryco-launch ${className ?? ""}`} {...base} aria-hidden>
...
export function WorktreeIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 100 100" className={`${SVG} ryco-worktree ${className ?? ""}`} {...base} aria-hidden>
      <line data-trace style={len(56)} x1="30" y1="26" x2="30" y2="78" />
      <path data-trace style={{ ...len(52), animationDelay: ".4s" }} d="M30 50 C30 66 50 61 66 61" />
...
export function ShipIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 100 100" className={`${SVG} ryco-ship ${className ?? ""}`} {...base} aria-hidden>
